...
ALTER TABLE user_role
    ADD CONSTRAINT fk_u_r FOREIGN KEY (user_id) REFERENCES users(id);

ALTER TABLE users
    ADD CONSTRAINT fk_u FOREIGN KEY (id) REFERENCES user_role;
...
INSERT INTO orders (price, status, customer_id, issue_date)
