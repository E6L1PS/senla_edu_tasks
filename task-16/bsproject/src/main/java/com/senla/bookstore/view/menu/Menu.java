    ...
    public void init() {
        ...
        this.menuItems = new MenuItem[]{
                new MenuItem("0. <--- Выход", () -> {
                    ...
                    JsonWriter.write(warehouseController.getBookRepository().findAll(), "Library.json");
                    JsonWriter.write(warehouseController.getWarehouseRepository().findAll(), "Warehouse.json");
                    JsonWriter.write(orderController.getOrderRepository().findAll(), "Orders.json");
                    JsonWriter.write(orderController.getRequestRepository().findAll(), "Requests.json");
                }, null),
                new MenuItem("1. Сервис книг", () -> System.out.println("\nВведите номер пункта"),
                        new Menu("Сервис книг", new MenuItem[]{
                                ...
                                new MenuItem("1. Сортировать книги по алфавиту", () -> System.out.println(bookController.getSortedBooks("name")), null),
                                new MenuItem("2. Сортировать книги по дате", () -> System.out.println(bookController.getSortedBooks("publicationDate")), null),
                                new MenuItem("3. Сортировать книги по цене", () -> System.out.println(bookController.getSortedBooks("price")), null),
                                new MenuItem("4. Сортировать книги по наличию на складе", () -> System.out.println(bookController.getSortedBooks("status")), null),
                                ...
                                new MenuItem("10. Посмотреть авторов", () -> System.out.println(bookController.getAuthors()), null),
                                new MenuItem("11. Запросы", () -> System.out.println("\nВведите номер пункта"),
                                        new Menu("Запросы", new MenuItem[]{
                                                ...
                                                new MenuItem("2. Сортировать запросы по алфавиту", () -> System.out.println(bookController.getRequestBooks("name")), null),
                                                new MenuItem("3. Сортировать запросы по количеству", () -> System.out.println(bookController.getRequestBooks("number")), null)
                                        }))
                        })),
                ...
                new MenuItem("2. Сервис заказов", () -> System.out.println("\nВведите номер пункта"),
                        new Menu("Сервис заказов", new MenuItem[]{
                                ...
                                new MenuItem("4. Сортировать заказы по дате исполнения", () -> System.out.println(orderController.getSortedOrders("issueDate")), null),
                                new MenuItem("5. Сортировать заказы по цене", () -> System.out.println(orderController.getSortedOrders("price")), null),
                                new MenuItem("6. Сортировать заказы по статусу", () -> System.out.println(orderController.getSortedOrders("status")), null),
