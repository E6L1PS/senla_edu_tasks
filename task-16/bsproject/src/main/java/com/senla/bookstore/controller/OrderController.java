...
public class OrderController {
    ...
    //TODO change mapping
    @GetMapping("/{startDate}/{endDate}/{key}")
    public List<OrderDTO> getCompletedOrders(@PathVariable LocalDate startDate, @PathVariable LocalDate endDate, @PathVariable String key) {
    ...
    public int getFullPrice(@PathVariable LocalDate startDate, @PathVariable LocalDate endDate) {
    ...
    public int getQuantityCompletedOrders(@PathVariable LocalDate startDate, @PathVariable LocalDate endDate) {
